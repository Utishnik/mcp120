...
public abstract class Raider extends PatrollingMonster {
   ...
   static final Predicate<ItemEntity> ALLOWED_ITEMS = (p_296862_) -> {
      return !p_296862_.hasPickUpDelay() && p_296862_.isAlive() && ItemStack.matches(p_296862_.getItem(), Raid.getLeaderBannerInstance());
   };
   @Nullable
   protected Raid raid;
   private int wave;
