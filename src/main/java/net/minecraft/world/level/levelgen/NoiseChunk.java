...
public class NoiseChunk implements DensityFunction.ContextProvider, DensityFunction.FunctionContext {
   ...
   public class NoiseInterpolator implements DensityFunctions.MarkerOrMarked, NoiseChunk.NoiseChunkDensityFunction {
      ...
      NoiseInterpolator(DensityFunction p_209345_) {
         ...
         System.out.println("cell   "+NoiseChunk.this.cellCountXZ + "  " + NoiseChunk.this.cellCountY);
      ...
      void selectCellYZ(int p_188864_, int p_188865_) {
         ...
         /*
         this.noise000 = Mth.sin((float)this.slice0[p_188865_][p_188864_]);
         this.noise001 = Mth.sin((float)this.slice0[p_188865_ + 1][p_188864_]);
         this.noise100 = Mth.sin((float)this.slice1[p_188865_][p_188864_]);
         this.noise101 = Mth.sin((float)this.slice1[p_188865_ + 1][p_188864_]);
         this.noise010 = Mth.sin((float)this.slice0[p_188865_][p_188864_ + 1]);
         this.noise011 = Mth.sin((float)this.slice0[p_188865_ + 1][p_188864_ + 1]);
         this.noise110 = Mth.sin((float)this.slice1[p_188865_][p_188864_ + 1]);
         this.noise111 = Mth.sin((float)this.slice1[p_188865_ + 1][p_188864_ + 1]);*/
      }
      ...
      //единственная функция используящая this.value
